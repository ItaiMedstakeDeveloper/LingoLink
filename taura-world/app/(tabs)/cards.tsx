      ...
      <View style={styles.container}>
        ...
        >
          ...
          <View style={styles.sectionZh}>
            <ThemedText
              style={[styles.textZhCharacters, { color: activeColors.primaryRed }]}
            >
              {currentWord.chinese}
            </ThemedText>
            <ThemedText
          ...
          <View style={styles.sectionFr}>
            ...
            <ThemedText
              style={[styles.textFrDetails, { color: activeColors.primaryBlue }]}
            >
          ...
          <View style={styles.sectionEn}>
            <ThemedText style={styles.textEnWord}>{currentWord.english}</ThemedText>
        ...
        <View style={styles.actionButtonsRow}>
          ...
          >
            ...
            />
            <ThemedText
              style={[styles.btnStudyAgainText, { color: activeColors.primaryRed }]}
            >
              Study again
            </ThemedText>
          </TouchableOpacity>
